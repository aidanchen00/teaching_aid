...
function RoomContent({ onCommandReceived }: { onCommandReceived?: (command: any) => void }) {
  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 p-4 bg-gray-950">
...
export function VideoRoom({ token, wsUrl, onCommandReceived }: VideoRoomContentProps) {
