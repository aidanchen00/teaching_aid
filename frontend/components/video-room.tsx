  ...
  return (
    <div className="w-full h-full flex flex-col gap-4 p-4 bg-gray-950 relative">
      ...
      <div className="absolute top-4 right-4 z-50 flex gap-2">
        {/* Openpreneurship Button - Links to localhost:3001 */}
        <a
          href="http://localhost:3001"
          target="_blank"
          rel="noopener noreferrer"
          className="px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-colors flex items-center gap-2 shadow-lg"
        >
        ...
        {hasOpenNoteMaterials && (
          <button
            ...
            className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors flex items-center gap-2 shadow-lg"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
